...
function useFirebase() {
  ...
  async function loadData(database: any) {
    try {
      ...
      if (prodSnap.exists()) setProductsState(Object.values(prodSnap.val()));
    ...
    return (
      <div className="fixed inset-0 bg-gray-950 flex flex-col items-center justify-center z-[9999]">
        <div className="text-center">
          <div className="text-2xl font-black text-white mb-1">Brand's<span className="text-blue-500">&pay</span></div>
